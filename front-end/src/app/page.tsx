...
export default function Page() {
  ...
  return (
    <div className={classes.wrapper}>
      <Overlay
        className={classes.overlayBehindBackground}
        gradient={`radial-gradient(ellipse at top, ${alpha(
          getThemeColor("teal.9", theme),
          0.95
        )} 0%, ${alpha(getThemeColor("green.5", theme), 0)} 50%)`}
        opacity={1}
      />
          ...
          >
            ...
            <Text component="div" size="xl" c="dimmed" ta="center">
              <Text>
                ...
                , your AI Interactive Tutor, is currently under construction!
              </Text>
